...
class User{
	...
	public static function loginOrRegister($email,$pass){

		// If such a user already exists, return it

		if(User::exists($email)){
			if(User::checkpass($email,$pass))
	...
	private static function create($email,$pass){
	...
	public static function checkpass($email,$pass){
